...
Refinery::Resources.configure do |config|
  ...
  # config.dragonfly_secret = "416cf64d70e2a5bd842ea4d183f1c7c1ca21fe2cbc13aed3"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/home/alfrednutile/www/rickrockstar/public/system/refinery/resources"

...
class QuestionSetsControllerTest < ActionController::TestCase
  ...
  test "should create question_set" do
    assert_difference('QuestionSet.count') do
      post :create, question_set: { api_id: @question_set.api_id, private: @question_set.private, set_id: @question_set.set_id }
    end
  ...
  test "should update question_set" do
    put :update, id: @question_set, question_set: { api_id: @question_set.api_id, private: @question_set.private, set_id: @question_set.set_id }
    assert_redirected_to question_set_path(assigns(:question_set))
  end
